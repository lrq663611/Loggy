...
<title>Mechanic Dashboard - Loggy Australia</title>
...
<div id="navi">
	<div class="width-container">
		...
		<div id="login-info">
			Logged in as <?=$this->session->userdata('company')?> (Mechanic)
		</div>
		<?php echo anchor('/auth/logout', '<div id="logout-btn" class="navi-item">LOG OUT</div>');?>
		<?php echo anchor('/service/list_works', '<div id="services-btn" class="navi-item">SERVICES</div>');?>
		<?php echo anchor('/service/update_account', '<div id="services-btn" class="navi-item">MY ACCOUNT</div>');?>
	</div>
</div>
