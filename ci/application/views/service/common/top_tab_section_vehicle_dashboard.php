<div class="gray-background">
	<div class="width-container">
		...
		<div id="top-tabs">
			...
			{
				echo anchor('service/list_works', '< BACK', array('class' => 'top-tab dark-tab'));
				echo "<div class='top-tab white-tab'>VEHICLE PROFILE</div>";
				echo anchor('service/vehicle_dashboard_service/'.$vehicle_id, 'SERVICE LOGBOOK', array('class' => 'top-tab light-tab'));
				echo anchor('service/vehicle_dashboard_part/'.$vehicle_id, 'PARTS PROFILE', array('class' => 'top-tab light-tab'));
			}

			if(in_array($method, $service_logbook_arr))
			{
				echo anchor('service/list_works', '< BACK', array('class' => 'top-tab dark-tab'));
				echo anchor('service/vehicle_dashboard_vehicle/'.$vehicle_id, 'VEHICLE PROFILE', array('class' => 'top-tab light-tab'));
