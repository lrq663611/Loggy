...
function get_service_details(id){
	$.ajax({
		url: "<?php echo site_url();?>service/get_service_details/"+id,
		dataType: "json",
...
function get_part_changed_details(id){
	$.ajax({
		url: "<?php echo site_url();?>service/get_part_changed_details/"+id,
		dataType: "json",
		success: function(msg) {
			$.each(msg, function(i,item){
...
function get_change_soon_details(id){
	$.ajax({
		url: "<?php echo site_url();?>service/get_change_soon_details/"+id,
		dataType: "json",
		success: function(msg) {
			$.each(msg, function(i,item){
