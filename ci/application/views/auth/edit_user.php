...
<div class="width-container">
	...
	<?php echo form_open(uri_string(), array('class' => 'dashboard-form')) ?>
		...
		<p>
			<?php echo lang('edit_user_suburb_label', 'suburb');?> <br />
			<?php echo form_input($suburb);?>
		</p>
		
		<p>
			<?php echo lang('edit_user_postcode_label', 'postcode');?> (State is determined by postcode)<br />
