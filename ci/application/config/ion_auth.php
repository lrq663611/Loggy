 ...
 */
$config['site_title']                 = "loggy.com.au";       // Site Title, example.com
$config['admin_email']                = "andrew@emoceanstudios.com.au"; // Admin Email, admin@example.com
$config['default_group']              = 'members';           // Default group, use name. //Can't be empty. Everyone must be a member at least
...
$config['user_expire']                = 2592000;//30 days               // How long to remember the user (seconds). Set to zero for no expiration
